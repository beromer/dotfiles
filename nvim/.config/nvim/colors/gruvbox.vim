...
if has("spell")
  ...
  if g:gruvbox_improved_warnings == 0
    call s:HL('SpellCap',   s:none, s:none, s:undercurl . s:italic)
  else
    call s:HL('SpellCap',   s:green, s:none, s:bold . s:italic)
  endif
  " Not recognized word
  call s:HL('SpellBad',   s:none, s:none, s:undercurl . s:italic)
  " Wrong spelling for selected region
  call s:HL('SpellLocal', s:none, s:none, s:undercurl . s:italic)
  " Rare word
  call s:HL('SpellRare',  s:none, s:none, s:undercurl . s:italic)
endif
